      ...
      <div class="share-modal-overlay" id="share-modal">
        <div class="share-modal-container" style="max-width: 500px;">
          <div class="share-modal-header">
            ...
            <button class="share-modal-close-button" id="close-share-modal" aria-label="Close Share Modal">✕</button>
          </div>

          <div class="share-modal-content">
            <div class="share-button-container">
              {/* Facebook */}
              <button aria-label="Share on Facebook" class="share-button" data-platform="facebook">
              ...
              {/* WhatsApp */}
              <button aria-label="Share on WhatsApp" class="share-button" data-platform="whatsapp">
              ...
              {/* Telegram */}
              <button aria-label="Share on Telegram" class="share-button" data-platform="telegram">
              ...
              {/* LinkedIn */}
              <button aria-label="Share on LinkedIn" class="share-button" data-platform="linkedin">
              ...
              {/* Line */}
              <button aria-label="Share on Line" class="share-button" data-platform="line">
              ...
              {/* Pinterest */}
              <button aria-label="Share on Pinterest" class="share-button" data-platform="pinterest">
              ...
              {/* Facebook Messenger */}
              <button aria-label="Share on Facebook Messenger" class="share-button" data-platform="messenger">

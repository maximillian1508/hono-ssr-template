            ...
            <div class="footer-column">
              ...
              <div class="footer-contact-buttons">
                <button class="footer-contact-btn" id="footer-whatsapp-button">
                  <svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="WhatsAppIcon" style="fill:white;background-color:#25d366;border-radius:50%;padding:5px;width:26px;height:26px">
                ...
                <button class="footer-contact-btn" id="footer-call-button">
                  <svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="CallIcon" style="fill:white;background-color:#3462F4;border-radius:50%;padding:5px;width:26px;height:26px">

          ...
          <nav>
            <ul class="mobile-nav-list">
              <li class="mobile-nav-item">
                <a href={`${baseUrl}/property-for-sale`} class="mobile-nav-link">
                  Buy
                </a>
              </li>
              <li class="mobile-nav-item">
                <a href={`${baseUrl}/property-for-rent`} class="mobile-nav-link">
                  Rent
                </a>
              </li>
              <li class="mobile-nav-item">
                <a href={`${baseUrl}/project-listing`} class="mobile-nav-link">
                  Projects
                </a>
              </li>
              <li class="mobile-nav-item">
                <a href={`${baseUrl}/insider-guide`} class="mobile-nav-link">
                  Resources
                </a>
              </li>
              <li class="mobile-nav-item">
                <a href={`${baseUrl}/looking-for-agent`} class="mobile-nav-link">
                  Others
                </a>
              </li>
              <li class="mobile-nav-item">
